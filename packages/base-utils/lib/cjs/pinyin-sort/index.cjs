...
var pinyin_sort_exports = {};
__export(pinyin_sort_exports, {
  Pinyin: () => Pinyin,
  instance: () => instance
});
module.exports = __toCommonJS(pinyin_sort_exports);
...
var Pinyin = class _Pinyin {
  ...
  constructor(ops = {}) {
    ...
    this.char_dict = import_data.char_dict;
    this.full_dict = import_data.full_dict;
    this.polyphone = import_data.polyphone;
  }
  // 提取拼音, 返回首字母大写形式
  getFullChars(str) {
    let result = "";
